...
begin
   ...
   FColorsGraph := TArray<TAlphaColor>.Create(
      TAlphaColors.Steelblue,
      TAlphaColors.Forestgreen,
...
begin
   ...
   try
      ...
      PieMask.Stroke.Color := TShape(FLayout.Parent).fill.Color;
      PieMask.Fill.Color := TShape(FLayout.Parent).fill.Color;
      ...
      begin
         ...
         Circle.Fill.Color := PieMask.Stroke.Color;
      ...
      begin
         ...
         if (ShowPercent) then
            ...
            //Leg := FormatFloat('0.00%', (jsonV / totValue) * 100);
